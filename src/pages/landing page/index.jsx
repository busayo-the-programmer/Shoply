...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 p-1.5 pr-4 mt-32 rounded-full border border-indigo-300 bg-indigo-50">
        <button className='bg-indigo-600 border border-indigo-700 text-white px-3 py-1 rounded-full text-xs'>New</button>
        <p className="text-xs text-indigo-700 font-medium">Built for modern shoppers and vendors</p>
      </div>

      <h1 className="text-4xl md:text-7xl text-center font-semibold max-w-3xl mt-5 text-gray-900 leading-tight">
        Shop smarter, with{' '}
        <span className="text-indigo-600">Vendora and co</span>
      </h1>
...
const features = [
  {
    ...
    description:
      "Browse thousands of curated products with smart filters, instant previews, and one-tap checkout — built for speed and delight.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Manage listings, track orders, and grow your store with real-time analytics and smart inventory tools.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description:
      "Competitive tiered commission rates that reward your growth — the more you sell, the more you keep.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    tag: "Discounts",
    title: "Smart Deals Engine",
    description:
      "Automated discount rules, flash sales, and coupon stacking — buyers love it, and your conversion rates will too.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description:
      "Points on every purchase, redeemable for discounts, free shipping, or exclusive early-access drops.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    accent: "pink",
    stat: "10× faster rewards",
  },
  {
    tag: "Incentives",
    title: "Referral Bonuses",
    description:
      "Invite friends, earn credits. Both sides win — your network grows your balance automatically.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function FeaturesSection() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#F5F7FF] to-[#EEF2FF] py-24 px-6 sm:px-10 md:px-24">
      <div className="max-w-7xl mx-auto">

        {/* Header */}
        <div className="flex flex-col items-center text-center mb-16">
          <span className="text-xs font-semibold tracking-widest text-indigo-500 uppercase mb-3 bg-indigo-50 border border-indigo-200 px-4 py-1.5 rounded-full">
            Why choose us
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-gray-900 max-w-2xl leading-tight">
            Everything you need to{" "}
            <span className="text-indigo-600">buy, sell & grow</span>
          </h2>
          <p className="mt-4 text-gray-500 text-sm sm:text-base max-w-lg leading-relaxed">
            A complete commerce platform with perks built in — for shoppers who want more and sellers who mean business.
          </p>
        </div>
          ...
          {features.map((f, i) => {
            ...
            return (
              <div
                ...
                className={`
                  relative rounded-2xl border border-gray-200 bg-white p-7 flex flex-col gap-5
                  transition-all duration-300 cursor-default
                  ${a.border} ${a.glow}
                  ${hovered === i ? "shadow-xl -translate-y-1" : "shadow-sm"}
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <span className={`text-xs font-medium px-3 py-1 rounded-full ${a.tag}`}>
                    {f.tag}
                  </span>
                </div>
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                  <span className={`text-sm font-semibold ${a.stat}`}>{f.stat}</span>
                  <a
                    href="#"
                ...
                <div className={`absolute inset-0 rounded-2xl ${a.bg} opacity-0 transition-opacity duration-300 pointer-events-none ${hovered === i ? "opacity-30" : ""}`} />
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-3">
           <Link to= "/auth/register">
              <button className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm px-7 py-3 rounded-full transition shadow-md">
              Start for free
            </button>
           </Link>
       <Link to= "/about">
          <button className="text-indigo-600 bg-indigo-100 hover:bg-indigo-200 text-sm px-6 py-3 rounded-full transition font-medium">
            View all features
          </button>
       </Link>
